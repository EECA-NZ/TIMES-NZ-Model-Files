...
- **Geopolitical forces**: Trade and synchronicity between New Zealand and the rest of the world. This impacts global demand for our export goods, and the availability and costs of imported technologies. 
...
Climate policy is expanded, carbon prices rise, and individuals make more climate-conscious decisions. LNG is not pursued, and more alternative options are explored for gas supply, including biomass and biogas."
```
...
Nationally, we continue with a more individualistic approach. Successive governments rely solely on the Emissions Trading Scheme (ETS) as an instrument of climate policy. No complementary measures are introduced, except those which are already in progress. Current carbon price and forestry settings remain, and the carbon prices stabilises at $52/tonne by 2035, in line with government carbon price projections[^mfe_erp2_detail]. Individual passenger vehicle demand grows in line with central projections. There is some community resistance to renewable electricity projects.

Domestic reserves of natural gas follow current projections, and no new domestic reserves are uncovered. LNG may be imported via floating infrastructure to meet demand if this is an optimal solution for the modelled energy system.
...
Global demand growth falls for protein-based agriculture, which partly drives the shift in economic structure. However, increased global trade, and large-scale regional trade blocs, mean that some technology costs fall faster as trade barriers are reduced. 
