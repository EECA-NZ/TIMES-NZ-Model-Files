...
**Model fixes**
- (Biofuel) Ensured electricity inpute share limites were incorported in to the biofuel processes.
- (Commercial) Resolved an error that led to some demand technologies being cheaper than intended.
- (Electricity) Ensured biogas and black pellets were properly integrated into the electricity generation.
