...
Although AD and biomass technologies can technically provide dispatchable generation or CHP, these roles are not currently enabled as capacity-expansion options in the electricity module. Bioenergy therefore does not compete as a firming or peak-serving technology in the present model structure.
