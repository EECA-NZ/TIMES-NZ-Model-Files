...
In TIMES-NZ 2.0 the model could choose between centralised and decentralised hydrogen – for 3.0 it has been assumed that all production will be decentralised (such as onsite at a vehicle refuelling station). This was added in TIMES-NZ 2.0 to show the different approaches, hinging on centralised systems having lower electrolyser costs through economies of scale, but higher transport costs to get the hydrogen to its end use destination. Commonwealth Scientific and Industrial Research Organisation (CSIRO) analysis[^gencost_2024-25] found that these economies of scale haven’t occurred, and the installations we are seeing in New Zealand are decentralised, so the centralised production and its associated transport options have been removed.
