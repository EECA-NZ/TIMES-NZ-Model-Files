...
def define_fuel_delivery(df):
    ...
    fuel_deliv_definitions = fuel_deliv_parameters["TechName"].copy()
    fuel_deliv_definitions["Sets"] = "PRE"
    fuel_deliv_definitions["Tact"] = ACTIVITY_UNIT
    fuel_deliv_definitions["Tcap"] = CAPACITY_UNIT
