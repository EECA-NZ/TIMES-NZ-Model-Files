...
COMMERCIAL_ASSUMPTIONS = ASSUMPTIONS / "commercial_demand"
COMMERCIAL_CONCORDANCES = CONCORDANCES / "commercial"
COMMERCIAL_DATA_DIR = STAGE_2_DATA / "commercial"

CHECKS_DIR = COMMERCIAL_DATA_DIR / "checks"
PREPROCESSING_DIR = COMMERCIAL_DATA_DIR / "preprocessing"
...
def save_output(df, name, label, filepath=COMMERCIAL_DATA_DIR):
    """Save DataFrame output to the output location."""
