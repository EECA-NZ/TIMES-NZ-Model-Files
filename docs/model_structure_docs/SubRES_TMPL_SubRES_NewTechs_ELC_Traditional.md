...
Conservative cost curve projections for residential rooftop solar (NREL Conservative)
...
Standard cost curve projections for offshore wind plants (NREL conservative)
