...
SubRES Transformation - ensure offshore wind built in correct islands
...
Ensure genstack plants end up in the right island(Transformation settings)


 - Veda Tag: `~TFM_AVA`


 - Data Location: `data_intermediate/stage_4_veda_format/subres_elc/genstack/Transformation_island_definitions.csv`
